import { IBrowserNavigationTimingPayload } from 'modules/messages/schemas/IBrowserNavigationTimingPayload';
...
export function getBrowserNavigationTimingOffsets(browserNavigationTimingPayload: IBrowserNavigationTimingPayload): IBrowserNavigationTimingOffsets {
    const {
        connectEnd,
        redirectStart,
        fetchStart,
