...
import { ILoggingFilterValue, LoggingMessageLevel } from './LoggingInterfaces';
import { showAllAction, toggleLevelAction, toggleAgentAction } from './LoggingActions';

function toggleFilter(filtersState: ILoggingFilterValue, targetFilter: AgentType | LoggingMessageLevel): ILoggingFilterValue {
...
export function levelFiltersReducer(state: ILoggingFilterValue = defaultLevelFiltersState, action: Action) {
    switch (action.type) {
...
export function agentFiltersReducer(state: ILoggingFilterValue = defaultAgentFiltersState, action: Action) {
    switch (action.type) {
