...
import RequestResourceView from './RequestResource';
        ...
        return (
            <div className={styles.view}>
                <div className={commonStyles.contextSection}>
                    <RequestResponseTabStripView requestConfig={requestConfig} responseConfig={responseConfig} detailAxis="request" requestAxis={requestAxis} responseAxis={responseAxis} />
                </div>
                <div className={commonStyles.contextSection}>
                    <RequestMiddlewareView />
                </div>
                <div className={classNames(commonStyles.contextSection, commonStyles.contextSectionEnd)}>
                    <RequestResourceView />
                </div>
            </div>
        );
