...
import { IDataHttpRequestPayload } from 'modules/messages/schemas/IDataHttpRequestPayload';
import { IDataHttpResponsePayload } from 'modules/messages/schemas/IDataHttpResponsePayload';
...
export interface IExchangeModel extends ITimelineComponentSpan {
     ...
     */
    request?: IMessage<IDataHttpRequestPayload>;

    /**
     * (Optional) The response message for the exchange.
     */
    response?: IMessage<IDataHttpResponsePayload>;
}
...
export interface IServiceResizePersistedState {
    /**
     * if service bottom panel is in open or close state
     */
    isOpen: boolean;

    /**
     * service bottom panel height
     */
    height: number;
}
