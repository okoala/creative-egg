...
import resizeReducer from './ServiceResizeReducer';
...
function toggleFilter(filtersState: IFilterValue, targetFilter: AgentType | StatusCodeClass): IFilterValue {
...
export function statusCodeFiltersReducer(state: IFilterValue = defaultStatusCodeFiltersState, action: Action) {
    switch (action.type) {
...
export function agentFiltersReducer(state: IFilterValue = defaultAgentFiltersState, action: Action) {
    switch (action.type) {
 ...
 */
export function servicePersistedRequestReducer(state: IServicePersistedRequestState = {}, action: Action): IServicePersistedRequestState {
    switch (action.type) {
