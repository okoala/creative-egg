...
import { buildRequestRouteData, buildResponseRouteData, createRouteConfig } from 'routes/requests/details/components/request-response-tab-strip/RequestResponseTabStripConfig';

import { QueryView } from 'routes/requests/details/components/request-response-tab-strip/query/QueryView';
import { RequestCookiesView, ResponseCookiesView } from 'routes/requests/details/components/request-response-tab-strip/cookies/CookiesView';
