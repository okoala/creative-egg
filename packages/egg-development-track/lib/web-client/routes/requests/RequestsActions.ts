...
export const disableFollowModeAction = createSimpleActionCreator('request.controls.followMode.disable');

export const toggleFollowModeAction = createSimpleActionCreator('request.controls.followMode.toggle');
...
export function setupRequestPurgeOldRecords(dispatcher: Dispatch<any>) { // tslint:disable-line:no-any
