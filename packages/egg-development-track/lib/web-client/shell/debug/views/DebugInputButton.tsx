...
import { fetchReceived } from 'modules/messages/messages-actions';
...
import styles from './DebugInputButton.scss';
...
export class DebugInputButton extends React.Component<IDebugInputButtonCombinedProps, IDebugInputButtonState> {
    constructor(props) {
        super(props);
    ...
    public render() {
        ...
        return (
            <div>
                <button aria-label="Import Messages" className={shellStatusBarStyles.statusBarButton} type="button" onClick={this.openModal}>
                    <Icon target={Icon.paths.Import} className={shellStatusBarStyles.statusBarButtonIcon} />
                </button>
                <Modal
                    isOpen={modalIsOpen}
                    ...
                    <div className={commonStyles.modalInner}>
                        ...
                        <form onSubmit={this.handleSubmit}>
                            <label>
                                Messages:
                                <textarea className={styles.input} value={this.state.value} onChange={this.handleChange} />
                            </label>
...
export default connect(mapStateToProps, mapDispatchToProps)(DebugInputButton) as React.ComponentClass<{}>;
