import { default as telemetryClient, IProperties } from 'modules/telemetry/TelemetryClient';
...
export function reportWindowOnError(source: string, lineNumber: number, columnNumber: number, errorMessage: string, errorObject: Error) {
