...
*/
export default class DataLoadingTimer extends React.Component<IDataLoadingTimerProps, IDataLoadingTimerState> {
    private timerId: number;

    public static defaultProps = {
        className: '',
        timeout: 5000,
        getLoadingStatusBlock: () => { return 'Loading...'; },
        getEmptyStatusBlock:  () => { return 'Nothing loaded.'; }
    };
    ...
    private getStatusBlock(): JSX.Element | string {
        ...
        return (this.state.isTimeoutElapsed)
                ? getEmptyStatusBlock() : getLoadingStatusBlock();
    }
