...
export interface IIconTarget {
    path?: string;
    render?: (svgProps) => JSX.Element;
    viewBox: string;
}
...
export class Icon extends React.Component<IIconProps, {}> {
    ...
    private static vsCodeViewBox = '0 0 16 16';
    private static fontAwesomeViewBox = '0 0 1792 1792';
    private static winstrapViewBox = '0 0 2048 2048';
    private static expandCollapseAllViewBox = '0 0 1000 1000';
    private static vsViewBox = '0 0 2048 2048';

    public static paths = {
        Smiley: {
            path: 'M8,1C4.1,1,1,4.1,1,8c0,3.9,3.1,7,7,7s7-3.1,7-7C15,4.1,11.9,1,8,1z M10,5c0,0,1,0.4,1,1.5C11,7,10.5,7,10,7C9.4,7,9,7,9,6.5C9,5.4,10,5,10,5z M6,5c0,0,1,0.4,1,1.5C7,7,6.5,7,6,7C5.4,7,5,7,5,6.5C5,5.4,6,5,6,5z M8,12c-1.9,0-3.4-1.3-3.9-3h1c0.4,1.2,1.6,2.1,2.9,2.1s2.5-0.9,2.9-2.1h0.9C11.4,10.7,9.9,12,8,12z',
            viewBox: Icon.vsCodeViewBox
        },
        SmileySad: {
            path: 'M8,1 C4.1,1 1,4.1 1,8 C1,11.9 4.1,15 8,15 C11.9,15 15,11.9 15,8 C15,4.1 11.9,1 8,1 Z M10,5 C10,5 11,5.4 11,6.5 C11,7 10.5,7 10,7 C9.4,7 9,7 9,6.5 C9,5.4 10,5 10,5 Z M6,5 C6,5 7,5.4 7,6.5 C7,7 6.5,7 6,7 C5.4,7 5,7 5,6.5 C5,5.4 6,5 6,5 Z M8.19434517,8.43691514 C9.81341672,8.46517614 11.0758558,9.39125599 11.4812979,10.5805443 L10.629155,10.5656701 C10.3028597,9.72547249 9.29120958,9.08193753 8.18342378,9.06260105 C7.07563798,9.04326458 6.04214509,9.65110144 5.68672607,10.4793996 L4.91979744,10.4660129 C5.28128389,9.29011137 6.57527362,8.40865414 8.19434517,8.43691514 Z',
            viewBox: Icon.vsCodeViewBox
        },
        // Expanded/Collapse
        CaretDown: {
        ...
        ChevronDown: {
            path: 'M1023.00006,1392l915-915,90,90-1005,1005L18,567l90.00006-90,915,915Z',
            viewBox: Icon.vsViewBox
        },
        ChevronUp: {
            path: 'M1955,1580,1024,650,93,1580,3,1490,1024,468,2045,1490l-90,90Z',
            viewBox: Icon.vsViewBox
        },
        ExpandAll: {
        ...
        FollowMode: {
            render: ({ className }) => <g>
                <path d="M1683.6,1930.6L1486.7,1538l-235.5,235.5V620.9l791.2,789.6H1760l192.8,384.5L1683.6,1930.6z M1513.9,1369.3l214.1,426.9 l90.7-45.6L1598,1310.5h202.6L1351.2,862v670.1L1513.9,1369.3z" className={className}/>
                <polygon points="1284.8,1153.8 1.9,1153.8 1.9,169.9 1752.6,169.9 1752.6,1142.1 1652.6,1142.1 1652.6,269.9 101.9,269.9 101.9,1053.8 1284.8,1053.8" className={className}/>
            </g>,
            viewBox: Icon.vsViewBox
        },
        ...
        CategorySquare: {
            path: 'M198,199h1650v1650H198V199z',
            viewBox: Icon.winstrapViewBox
        },

        // Alerts
        TimesCircle: {
            //EB90_statusErrorFull
            path: 'M1024,0c565,0,1024,459,1024,1024S1589,2048,1024,2048,0,1589,0,1024,459,0,1024,0Zm113,1024,342-342L1366,569,1024,911,682,569,569,682l342,342L569,1366l113,113,342-342,342,342,113-113-342-342Z',
            viewBox: Icon.winstrapViewBox
        },

        Warning: {
            //E814_IncidentTriangle
            path: 'M1984,1984H64L1024,64l960,1920Zm-896-384.00006H960.00006V1728H1088V1599.99994ZM1088,1472V832H960.00006v640Z',
            viewBox: Icon.winstrapViewBox
        },
        ...
        // Overview
        Chart: {
            path: 'M0,320h2048v1408H0V320z M1921,1601V448h-514v384h-127V448H768v128H640V448H128v1153h512V960h128v641h512v-129h127v129 H1921z M256,832V704h640v128H256z M1536,960v128H897V960H1536z M1280,1344v-128h512v128H1280z',
            viewBox: Icon.vsViewBox
        },
        ...
        Lock: {
            //E1F6_LockLegacy.svg
            path: 'M1792,896V2048H256V896H512V522C512,234,733,0,1024,0s512,234,512,522V896ZM640,896h768V522c0-216-164-394-384-394S640,306,640,522V896Zm1024,128H384v896.00006H1664V1024Z',
            viewBox: Icon.winstrapViewBox
        },

        Request: {
            path: 'M1038.5,9.5l903.7,1355.5l-903.7,677.8l-903.7-677.8L1038.5,9.5z M1670.9,1318.6l-632.3-948.5l-632.3,948.5l632.3,474.3L1670.9,1318.6z',
            viewBox: Icon.vsViewBox
        },

        Response: {
            path: 'M1038.5,2042.9L134.8,687.3L1038.5,9.5l903.7,677.8L1038.5,2042.9z M406.2,733.8l632.3,948.5l632.3-948.5l-632.3-474.3L406.2,733.8z',
            viewBox: Icon.vsViewBox
        },
        ...
        InfoLogs: {
            // F167_InfoSolid
            path: 'M1024,64c530,0,960,430,960,960s-430,960.00006-960,960.00006S64,1554,64,1024,494,64,1024,64Zm64,768H960.00006v640H1088V832Zm0-256H960.00006V704H1088V576Z',
            viewBox: Icon.vsViewBox
        },

        Information: {
            // Question custom made
            path: 'M1024,1984c-532,0-960-428-960-960S492,64,1024,64s960,428,960,960S1556,1984,1024,1984z M1024,192c-459,0-832,374-832,832s373,832,832,832c458,0,832-373,832-832C1856,566,1482,192,1024,192L1024,192z M924.9,1166.3c0-52.3,6.3-95.4,18.9-129.2c12.6-33.9,27.8-60.4,45.7-79.5c17.9-19.1,41.2-39.3,69.7-60.6c21.8-16.5,39-30.7,51.6-42.8c12.6-12.1,23-27.4,31.2-45.8c8.2-18.4,12.3-40.6,12.3-66.8c0-44.5-14.8-79.3-44.3-104.2c-29.5-24.9-71.4-37.6-125.6-38.1c-45,0-104.6,8.5-178.6,25.4l-26.9-110.4c32.9-8.7,68.1-15.5,105.7-20.3c37.5-4.8,73.9-7.3,109.3-7.3c87.6,0,155.4,21.2,203.3,63.5s71.9,102.3,71.9,179.7c0,48.9-5.9,89.4-17.8,121.6c-11.9,32.2-26.2,57.4-42.8,75.5c-16.7,18.2-38.8,37.9-66.4,59.2c-22.8,17.4-40.8,32.9-54.1,46.5c-13.3,13.6-24.3,30.9-33,51.9c-8.7,21.1-13.1,46.8-13.1,77.3v122H924.9V1166.3z M931,1539.2c-14.8-14.8-22.1-34.5-22.1-59.2s7.4-44.5,22.1-59.6c14.8-15,34.5-22.5,59.2-22.5c24.7,0,44.5,7.5,59.5,22.5c15,15,22.5,34.9,22.5,59.6s-7.5,44.4-22.5,59.2c-15,14.7-34.8,22.1-59.5,22.1C965.5,1561.3,945.8,1554,931,1539.2z',
            viewBox: Icon.winstrapViewBox
        },

        Go: {
            // E1AA_GoLegacyMirrored.svg
            path: 'M1025,2V130H220L2046,1957l-90,90L128.99994,221v805H1V2Z',
            viewBox: Icon.vsViewBox
        },
        ...
        Fire: {
            path: 'M1278.5,69.6c0,118.7,21.9,228,65.6,328.1c43.7,100.1,106.7,192.2,188.9,276.4c82.1,84.2,145.1,176.3,188.9,276.4c43.7,100.1,65.6,209.5,65.6,328.1c0,70.3-9.1,137.9-27.3,202.8c-18.3,65-43.9,125.7-77,182.4c-33.2,56.7-73,108.2-119.3,154.6c-46.4,46.4-97.9,86.2-154.6,119.3c-56.7,33.2-117.5,58.8-182.4,77c-65,18.3-132.6,27.3-202.8,27.3c-70.3,0-137.9-9.1-202.8-27.3c-65-18.2-125.8-43.9-182.4-77c-56.7-33.1-108.2-72.9-154.6-119.3c-46.4-46.4-86.2-97.9-119.3-154.6c-33.2-56.7-58.8-117.4-77-182.4c-18.3-64.9-27.3-132.5-27.3-202.8c0-55.7,6-110.4,17.9-164c11.9-53.7,29.1-105.2,51.7-154.6c22.5-49.3,50.3-95.9,83.5-139.7c33.1-43.7,70.6-83.8,112.3-120.3c4.6,25.2,10.9,51.2,18.9,78s17.4,53.4,28.3,79.5c10.9,26.2,23.4,51.4,37.3,75.6c13.9,24.2,29.1,46.2,45.7,66.1c13.2,16.6,30.4,24.9,51.7,24.9c17.9,0,32.9-6.3,45.2-18.9c12.2-12.6,18.4-27.8,18.4-45.7c0-7.3-1.2-13.9-3.5-19.9c-2.4-6-5.5-11.9-9.4-17.9c-18.6-27.2-35-54-49.2-80.5c-14.3-26.5-26.3-53.7-36.3-81.5c-9.9-27.8-17.6-56.7-22.9-86.5c-5.3-29.8-8-61.3-8-94.4c0-78.8,15-153.1,45.2-222.7c30.1-69.6,71.1-130.2,122.8-181.9C862,122.3,922.6,81.4,992.2,51.2C1061.8,21.1,1136,6,1214.9,6h63.6V69.6z M1024,1914.8c88.1,0,170.8-16.5,248-49.7c77.2-33.1,144.6-78.5,202.3-136.2c57.7-57.7,103-125.1,136.2-202.3c33.1-77.2,49.7-159.9,49.7-248c0-100-18.6-193.2-55.7-279.4c-37.2-86.1-90.8-164.3-161-234.6c-86.2-86.8-154-182.5-203.3-287.3c-49.4-104.7-78.4-218-87-340c-55,7.3-105.9,24-152.6,50.2c-46.7,26.2-87.4,59-121.8,98.4c-34.5,39.5-61.3,84.2-80.5,134.2c-19.3,50.1-28.8,102.9-28.8,158.6c0,51.7,7.6,98.6,22.9,140.7c15.2,42.1,37.8,83.7,67.6,124.8c12.6,17.3,22.4,35.3,29.3,54.2c7,18.9,10.4,39.3,10.4,61.1c0,26.5-5.2,51.4-15.4,74.6c-10.3,23.2-24,43.6-41.3,61.1c-17.3,17.6-37.5,31.3-60.6,41.3c-23.2,9.9-48.1,14.9-74.6,14.9c-30.5,0-57.4-5.8-80.5-17.4c-23.2-11.6-43.7-26.8-61.6-45.7c-17.9-18.9-34-40.3-48.2-64.1c-14.3-23.9-27.3-47.7-39.3-71.6c-30.5,48.4-53.2,100.6-68.1,156.6c-14.9,56-22.4,112.5-22.4,169.5c0,88.2,16.5,170.9,49.7,248c33.1,77.2,78.5,144.6,136.2,202.3c57.7,57.7,125.1,103.1,202.3,136.2C853.1,1898.2,935.8,1914.8,1024,1914.8z',
            viewBox: Icon.winstrapViewBox
        },
    ...
    public renderPath() {
        const { target, pathClassName } = this.props;
        ...
        return <path className={classNames(styles.iconPath, pathClassName)} d={path} />;
    }
    ...
    public render() {
        ...
        const viewBox = target && target.viewBox || Icon.vsCodeViewBox;
        const render = target && target.render || undefined;

        return (
            <svg className={className} onClick={onClick} onKeyDown={onKeyDown} viewBox={viewBox} aria-label={ariaLabel}>
                {render
                    ? render({ className: pathClassName })
                    :  this.renderPath()
                }
            </svg>
        );
