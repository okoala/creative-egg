...
import { IWebRequestPayload } from 'modules/messages/schemas/IWebRequestPayload';
import { IWebResponsePayload } from 'modules/messages/schemas/IWebResponsePayload';
...
const mediaTypeToMetadata: { [key: string]: IMediaTypeMetadata } = {
    'text/html': { contentTypeClass: ContentTypeClass.Document, highlight: 'xml', follow: true },
    'text/plain': { contentTypeClass: ContentTypeClass.Document, highlight: 'nohighlight' },
    'application/xhtml+xml': { contentTypeClass: ContentTypeClass.Document, highlight: 'xml' },
    'text/xml': { contentTypeClass: ContentTypeClass.Data, highlight: 'xml' },
    'application/json': { contentTypeClass: ContentTypeClass.Data, highlight: 'json' },
    ...
    'image/svg+xml': { contentTypeClass: ContentTypeClass.Image | ContentTypeClass.Font | ContentTypeClass.Document }, // tslint:disable-line:no-bitwise
    ...
    'application/octet-stream': { contentTypeClass: ContentTypeClass.Image | ContentTypeClass.Font }, // tslint:disable-line:no-bitwise
    ...
    'application/x-www-form-urlencoded': { contentTypeClass: ContentTypeClass.Data },
    'text/javascript': { contentTypeClass: ContentTypeClass.Script, highlight: 'javascript' },
    'text/ecmascript': { contentTypeClass: ContentTypeClass.Script, highlight: 'javascript' },
    'application/javascript': { contentTypeClass: ContentTypeClass.Script, highlight: 'javascript' },
    'application/ecmascript': { contentTypeClass: ContentTypeClass.Script, highlight: 'javascript' },
    'application/x-javascript': { contentTypeClass: ContentTypeClass.Script, highlight: 'javascript' },
    'text/javascript1.1': { contentTypeClass: ContentTypeClass.Script, highlight: 'javascript' },
    'text/javascript1.2': { contentTypeClass: ContentTypeClass.Script, highlight: 'javascript' },
    'text/javascript1.3': { contentTypeClass: ContentTypeClass.Script, highlight: 'javascript' },
    'text/jscript': { contentTypeClass: ContentTypeClass.Script, highlight: 'javascript' },
    'text/livescript': { contentTypeClass: ContentTypeClass.Script, highlight: 'livescript' },
...
export function classifyRequest(request: IMessage<IWebRequestPayload>, response: IMessage<IWebResponsePayload>): IMediaTypeMetadata {
...
export function getHeaderValue(headerKey: string, headers: { [key: string]: string | string[] }): string {
    if (headers) {
