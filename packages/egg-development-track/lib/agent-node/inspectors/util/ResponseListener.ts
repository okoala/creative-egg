...
export interface IServerResponseWithInternals extends http.ServerResponse {
  _header?: string;
  _trailer?: string;
}
...
export class ResponseListener extends events.EventEmitter {
  ...
  public static getAllHeaders(res: IServerResponseWithInternals): { [key: string]: string[] } {
