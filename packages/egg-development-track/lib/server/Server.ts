...
export class Server implements IServer {
  ...
  public constructor() {
    ...
    this._errorReportingService = new CompositeErrorReportingService(
      [
        new LoggingErrorReportingService(),
        new TelemetryErrorReportingService(this._telemetryService),
      ],
    );
  ...
  private registerResources() {
    for (const _resource of resources) {
      const resourceModule = require('./resources/' + _resource + 'Resource');
...
export const instance = new Server();
